...
//    boolean runThread = false;
    ...
    Arc arc2,arc4,arc6;
    //Misssion Status
    Circle ms_circle,ms_circle1,ms_circle2,ms_circle3,ms_circle4,ms_circle5,parachute_circle,aerobreaking_circle;
    ...
    Graphic pointGraphic,pointGraphic1;
    Point point1,point2;
    MapView mapView;
    Envelope envelope;
    ...
    public FlightMode(StackPane root1, int x, int y) {
        super(root1, x, y);
        dataWRect=410;
...
//        mapView.setMap(map);
        ...
        mapView.setViewpoint(new Viewpoint(19.5093036, -99.1339391, 5000));

        // create a point geometry with a location and spatial reference
//        point1 = new Point(-99.1339, 19.5093, SpatialReferences.getWgs84());
...
//        pointGraphic = new Graphic(point1, simpleMarkerSymbol);
//        point2 = new Point(-99.1341, 19.5095, SpatialReferences.getWgs84());
//        pointGraphic1 = new Graphic(point2, simpleMarkerSymbol);
//        // add the point graphic to the graphics overlay
//        graphicsOverlay.getGraphics().addAll(pointGraphic1);
...
//        graphicsOverlay.getGraphics().addAll(Arrays.asList(multipointGraphic));
        ...
        GPS_Altitude = new Text("2240.4040m");
//        Altitude.setFont(Font.font("HKGrotesk", FontWeight.SEMI_BOLD,18));
        ...
        GPSData.setColumnSpan(GPS_Altitude,2);
...
//				Voltage.setFont(Font.font("Brocades Sans"));
        ...
        parachute_circle = new Circle(20);
...
//        parachute_circle.setFill(Color.rgb(13, 211, 254));
        ...
        aerobreaking_circle = new Circle(20);
...
//		ms_line.setEffect(shadow);
        ...
        CommandsGrid.setGridLinesVisible(false);
...
//
                                            ...
                                            GPS_Latitude.setText(df.format(dataLat) + "°N");

                                            dataLon=Double.parseDouble(tel[15]);
                                            GPS_Longitude.setText(df.format(dataLon) + " °W");
...
//                                            Anim_GPS(dataLat,dataLon,stateCapitalsPST,multipoint,multipointGraphic,graphicsOverlay);
                                            Anim_GPS(dataLat,dataLon,point2,pointGraphic,graphicsOverlay);
...
//
    ...
    private static void startThrearTimer() {
        if (startThread = true) {
            System.out.println("START THREAD");
            timer = new clockGS(TM);
            try {
                timer.start();
            } catch (Exception e) {
                throw new RuntimeException(e);
            }
//					Thread threadClock = new Thread(timer);
...
//					threadClock.start();
    ...
    public void Anim_GPS(double dataLat, double dataLon, Point point2, Graphic pointGraphic1, GraphicsOverlay graphicsOverlay) {
        graphicsOverlay.getGraphics().clear();
        point2 = new Point(dataLon,dataLat, SpatialReferences.getWgs84());
        pointGraphic1 = new Graphic(point2, simpleMarkerSymbol);
        // add the point graphic to the graphics overlay
        graphicsOverlay.getGraphics().addAll(pointGraphic1);
        envelope = new Envelope(dataLon,dataLat,dataLon,dataLat, SpatialReferences.getWgs84());
...
//    }
public void Anim_States(String dataState) {
    if(Objects.equals(dataState, "P")) {
        ms_circle.setFill(Color.rgb(235, 253, 255));
        ms_circle1.setFill(Color.rgb(235, 253, 255));
        ms_circle2.setFill(Color.rgb(235, 253, 255));
        ms_circle3.setFill(Color.rgb(235, 253, 255));
        ms_circle4.setFill(Color.rgb(235, 253, 255));
        ms_circle5.setFill(Color.rgb(13, 211, 254));
    }
}
    public static void Anim_MS(double dataMS,Circle ms_circle,Circle ms_circle1,Circle ms_circle2,Circle ms_circle3,Circle ms_circle4,Circle ms_circle5) {
        ...
        shadow.setColor(Color.rgb(0, 72, 149));
        shadow.setRadius(40);
        if(dataMS==1) {
            ms_circle.setFill(Color.rgb(235, 253, 255));
            ms_circle1.setFill(Color.rgb(235, 253, 255));
...
//            ms_circle2.setEffect(shadow);
            ms_circle3.setFill(Color.rgb(13, 211, 254));
...
//            ms_circle.setEffect(shadow);
            ms_circle1.setFill(Color.rgb(235, 253, 255));
//            ms_circle1.setEffect(shadow);
            ms_circle2.setFill(Color.rgb(13, 211, 254));
//            ms_circle2.setEffect(shadow);
            ms_circle2.setEffect(shadow);
            ms_circle3.setFill(Color.rgb(13, 211, 254));
//            ms_circle3.setEffect(shadow);
            ...
            ms_circle.setFill(Color.rgb(235, 253, 255));
//            ms_circle.setEffect(shadow);
            ms_circle1.setFill(Color.rgb(13, 211, 254));
            ms_circle1.setEffect(shadow);
            ms_circle2.setFill(Color.rgb(13, 211, 254));
            ms_circle2.setEffect(shadow);
            ms_circle3.setFill(Color.rgb(13, 211, 254));
            ...
            ms_circle.setFill(Color.rgb(13, 211, 254));
            ms_circle.setEffect(shadow);
            ms_circle1.setFill(Color.rgb(13, 211, 254));
            ms_circle1.setEffect(shadow);
            ms_circle2.setFill(Color.rgb(13, 211, 254));
